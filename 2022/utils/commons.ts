...
// @ts-ignore
Object['filter'] = function (obj: { [s: string]: unknown; } | ArrayLike<unknown>, predicate: (value: [string, unknown], index: number, array: [string, unknown][]) => value is [string, unknown]) {
...
// @ts-ignore
Array.prototype['eachSlice'] = function (size: number, callback: { call: (arg0: any[], arg1: any[]) => void; }) {
...
Array.prototype['transpose'] = function () {
    return this[0].map((x: any, i: string | number) => this.map((y) => y[i]));
};
